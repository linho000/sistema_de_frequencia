...
window.onload = function(){
    ...
    enemyImg.src = "https://image.ibb.co/gi6ZpU/ufo.png"; //"https://image.ibb.co/gi6ZpU/ufo.png";
    var enemy_width = 40;
    var enemy_height = 40;
    ...
    healthkitImg.src = "https://image.ibb.co/gFvSEU/first_aid_kit.png"; //"https://image.ibb.co/gFvSEU/first_aid_kit.png";
    var healthkit_width = 60;
    var healthkit_height = 60;
    //sounds
    var shot = new Audio();
    ...
    function animate(){
      ...
      c.fillText("Monstros: " + health, 5, 20); //health
      c.fillText("Pontos: " + score, innerWidth-100, 20); //score
